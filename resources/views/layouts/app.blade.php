        ...
        <div class="container logo-wrap">
          <div class="row pt-5">
            <div class="col-12 text-center">
              ...
              <h1 class="site-logo"><a href="{{route('home')}}">Trinoq</a></h1>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <p class="small">
               Copyright &copy;All Rights Reserved | Made by <a href="http://trinoq.com/" target="_blank">Trinoq</a>
             </p>
